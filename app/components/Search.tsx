...
export default function SearchPage() {
  ...
  return (
    <div className="relative items-center flex justify-between pl-10 pr-10 gap-2 w-full max-w-lg h-12 rounded-md border border-neutral-800 bg-neutral-700/10 backdrop-blur hover:border-neutral-700/50 transition">
